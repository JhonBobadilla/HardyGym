...
// CORS solo para el dominio correcto (el frontend de Heroku)
const corsOptions = {
    origin: process.env.FRONTEND_URL || 'https://hardy-2839d6e03ba8.herokuapp.com', // URL del frontend en Heroku
    methods: ["GET", "POST"],
